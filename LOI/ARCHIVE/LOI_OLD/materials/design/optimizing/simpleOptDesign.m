...
% aH eH aL eL
L=[.5 .5 -.5 -.5; 1 -1 0 0]';   % contrasts of interest (each row = new contrast)
conWeights=[3 1];               % how to weight each contrast in overall efficiency estimation? 
TR=2.5;                               % your TR length                   
hpf=128;                            % your high-pass filter (in secs)
nruns=100000000;                          % how many different random designs to test?
maxtime=60*15;                      % max time to run (in minutes)
nkeep=5;                           % how many best designs to keep? 
