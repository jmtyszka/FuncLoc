...
trial_length=22;                 % trial length (in seconds)
% breakdown: 
% cueDur=1.25;
% stimDur=2.5;
% IEI=.15;
...
minISI=3;               % mininimum interstimulus interval (in seconds)
maxISI=6;               % maximum interstimulus interval (in seconds)
meanISI=4;              % desired mean interstimulus interval (in seconds)
