function run_loi(subjectID,inputDevice,w)
%=========================================================================
% LOICALIZER
%=========================================================================
...
%---------------------------------------------------------------
cd('C:\Documents and Settings\Localizers\My Documents\MATLAB\Localizers\loicalizer\stimuli');
stimpath = pwd;
d = dir('1*.jpg');
for i = 1:length(d)
  
  slideName{i} = d(i).name;
  slideTex{i} = Screen('MakeTexture',w,imread([pwd filesep slideName{i}]));
  
end;
cd('C:\Documents and Settings\Localizers\My Documents\MATLAB\Localizers\loicalizer');
Screen('FillRect', w, grayLevel);
Screen('Flip', w);
WaitSecs(0.1);
