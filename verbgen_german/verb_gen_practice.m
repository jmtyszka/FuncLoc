...
% 03/25/2013 JMT Translate to German. Tidy code.
...
if TESTING % THIS IS FOR DEBUGGING
  ...
  repetition = 1; % # repetitions of each type of block
  instrDur = 1.0;
  cueDur = instrDur;
  stimDur = 1.0;
  respDur = 2.0;
  nBlock  = 3; % # block types: few, many, read ('rest' condition has been eliminated)
  fixDur = 3.0;
end

trialDur = cueDur + stimDur + respDur + fixDur; % length of trial (7s)
nTrialPerBlock = 3; % # trials per block
