...
trial_length=14;                 % trial length (in seconds)
ntrials=sum(trials_per_cond); % computes total number of trials
minISI=8;               % mininimum interstimulus interval (in seconds)
maxISI=14;               % maximum interstimulus interval (in seconds)
meanISI=10;              % desired mean interstimulus interval (in seconds)
restBegin=16;            % amount of rest to add in beginning of scan (in seconds)
