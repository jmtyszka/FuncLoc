...
L=[1 -1]';   % contrasts of interest (each row = new contrast)
conWeights=[1];               % how to weight each contrast in overall efficiency estimation? 
TR=2;                               % your TR length                   
hpf=128;                            % your high-pass filter (in secs)
nruns=1000000;                          % how many different random designs to test?
maxtime=60*2;                      % max time to run (in minutes)
